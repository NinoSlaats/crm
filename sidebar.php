...
<div id="laadOverlay" style="display: none; position: fixed; inset: 0; background: rgba(255,255,255,0.75); z-index: 9999; justify-content: center; align-items: center; flex-direction: column; gap: 12px;">
    ...
    <div class="offcanvas-body d-md-flex flex-column p-0">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <?php if ($_SESSION['user_rol'] !== 'Medewerker'): ?>
                ...
                <li class="nav-item mb-2">
                    <a href="medewerkers.php" class="nav-link <?= in_array($huidige_pagina, ['medewerkers.php', 'medewerkers_toevoegen.php', 'medewerkers_bewerken.php']) ? 'active' : 'text-white' ?>">Medewerkers</a>
                </li>
            <?php endif; ?>
        </ul>
        <hr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function toonLaad() { overlay.style.display = 'flex'; }
