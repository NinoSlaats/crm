...
// 1. Opslaan van wijzigingen wanneer het formulier wordt verzonden
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $stmt = $conn->prepare("UPDATE werkzaamheden SET aantal_uren = ?, omschrijving = ? WHERE id = ? AND medewerker_id = ?");
